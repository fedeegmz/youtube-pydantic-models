...
class YoutubeClient:
    ...
    def get_channel(
        ...
        response = self._get_request(
            endpoint="channels",
            params=params,
            quota=self._quotas_table.LIST_CHANNEL,
        )
    ...
    def get_video(
        ...
        response = self._get_request(
            endpoint="videos",
            params=params,
            quota=self._quotas_table.LIST_VIDEO,
        )
    ...
    def get_playlists(
        ...
        response = self._get_request(
            endpoint="playlists",
            params=params,
            quota=self._quotas_table.LIST_PLAYLIST,
        )
    ...
    def search(
        ...
        response = self._get_request(
            endpoint="search",
            params=params,
            quota=self._quotas_table.SEARCH,
        )
    ...
    def iter_playlists(
        ...
        ------
            QuotaException : unavailable YouTube quota
        """
        request_quota = self._quotas_table.LIST_PLAYLIST
        base_params = {
            "channelId": channel_id,
            "part": part,
